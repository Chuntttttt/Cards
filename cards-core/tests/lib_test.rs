...
fn test_cardwriter_dimensions() {
    let _writer = CardWriter::new("test_path".to_string(), 3).unwrap();
...
fn test_cardwriter_different_grid_sizes() {
    let _writer_5x5 = CardWriter::new("test_path".to_string(), 5).unwrap();
...
fn test_images_from_path_sorting() {
    ...
    let _writer = CardWriter::new("../static".to_string(), 3).unwrap();
...
fn test_generate_pdf_bytes_returns_data() {
    let writer = CardWriter::new("../static/cards".to_string(), 3).unwrap();
...
fn test_error_directory_not_found() {
    let writer = CardWriter::new("nonexistent_directory".to_string(), 3).unwrap();
...
fn test_1x1_grid() {
    ...
    let writer = CardWriter::new("../static/cards".to_string(), 1).unwrap();
    let result = writer.generate_pdf_bytes();
...
fn test_empty_back_cards_directory() {
    ...
    let writer = CardWriter::new("../static".to_string(), 3).unwrap();
    let result = writer.generate_pdf_bytes();
